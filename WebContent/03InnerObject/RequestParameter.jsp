...
<body>
	...
	/* 
	전송방식 get/post에 상관없이 getParameter메소드로
	폼값을 받을 수 있다. 만약 값이 입력되지 않았아면 길이가 0인 String객체를
	...
	*/
	...
	if(!(name==null || name.equals(""))){
		...
		/*  
		스크립트넷 안에서 JS를 선언할때는 out.println()을 토해서 
		아래와 같이 사용할 수 있다. 또는 문자열을 연결하여 사용할 수 도 있다.
		*/
		out.println("<script>");
	...
	항목은 여러개 이나, 실제 선택가능한 항목은 하나이기 때문이다.
	*/
	...
	여러개의 항목중 체크가된 항목만 전송된다. 파라미터명이 틀리거나
	...
	*/
	...
	/* 
	textarea를 통해 입력받은 값은 엔터키(줄바꿈기호 \ r\n)가 포함되어있다.
