...
<body>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		<h3>요청 헤더보기</h3>
		<a href="RequestHeader.jsp">RequestHeader 바로보기</a>
		
		<div style="font-size: 14px; color: blue;">
			<ol>
				<li>RequestHeader자체실행: referer항목 보이지않음.</li>
				<li>Main을 실행후 링크를 통해 접속: refere항목 보임.</li>
				<!-- referer: 현재 접속한 페이지의 이전 URL의 정보를 담고 있다.
						이 정보를 통해 어떤 사이트에서 유입되었는지를 알수있다. -->
			</ol>
